...
--TRUNCATE TABLE import_Game013_log_EU
/*
CREATE TABLE Import_Game013_log_EU (
	Game013_logDetails NVARCHAR(MAX)
);
*/

--BULK INSERT dbo.import_Game013_log_EU
--FROM 'E:\SCWDemo\MongoExportEU\scw_prod_alpha_game_013.log_EU.json' 
--WITH (
--    ROWTERMINATOR = '0x0a'
--);
...
DROP TABLE #Game013_log;

CREATE TABLE #Game013_log (
...
DECLARE JSONIMPORT CURSOR FOR
 ...
 FROM dbo.import_Game013_log_EU
