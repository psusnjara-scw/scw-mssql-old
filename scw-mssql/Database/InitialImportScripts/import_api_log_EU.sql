...
--TRUNCATE TABLE import_api_log_EU
/*
CREATE TABLE Import_api_log_EU (
	api_logDetails NVARCHAR(MAX)
);
*/

BULK INSERT dbo.import_api_log_EU
FROM 'E:\SCWDemo\MongoExportEU\scw_prod_alpha_api.log_EU.json' 
WITH (
    ROWTERMINATOR = '0x0a'
);

-- SELECT count(*) from Import_api_log_EU
--SELECT * FROM dbo.import_api_log_EU
--  SELECT * FROM #api_log
--
...
SELECT *
FROM OPENROWSET (BULK 'E:\SCWDemo\MongoExportEU\scw_prod_alpha_game_013.api_log_EU.json', SINGLE_CLOB) as j
